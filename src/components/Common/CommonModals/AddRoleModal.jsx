          ...
          <ScrollView showsVerticalScrollIndicator={false}>
            <View style={styles.ApplicationContent}>
              ...
              {more_data.map((more_data, index) => {
                return (
                  <View key={index}>
                    <EmployeeCard onPressThree ={()=>navigation.navigate('chatbox',{chatName: more_data.name})} option={'Add'} selected = {'Added'} connectMore={true} data={more_data} />
                  </View>
                );
              })}
            </View>
            ...
            <View style={styles.ButtonView}>
              <CustomButton
                ...
                onPress={handleSubmit(props.onSubmitRoleModal)}
              />
            </View>
          </ScrollView>
        </View>
